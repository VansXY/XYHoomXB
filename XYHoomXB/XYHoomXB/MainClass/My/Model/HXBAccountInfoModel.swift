...
class HXBAccountInfoModel: NSObject {
    
    /// 单利
    static let shared = HXBAccountInfoModel()
    
    let userAssets = HXBUserAssetsModel()
    let userInfo = HXBUserInfoModel()
}

class HXBUserAssetsModel: NSObject {
    /// 累计收益
    ...
    /// 用户可购买产品风险类型集合:保守型：
    /// [“AA”,”A”,”CONSERVATIVE”];稳健性：[“AA”,”A”, “B”,”CONSERVATIVE”, “PRUDENT”]；激进型：[“D”, “AA”, “A”,”PROACTIVE”, “B”,”C”,”CONSERVATIVE”, “PRUDENT”]
...
class HXBUserInfoModel: NSObject {
